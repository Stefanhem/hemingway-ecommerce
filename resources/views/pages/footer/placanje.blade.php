...
@section('content')
    <div class="contact-section legal-notice">
        ...
        <p class="paragraph-222 legal-paragraph" style="width: 100%">
            Za narudžbine sa teritorije Republike Srbije, u ovom trenutku moguća su dva načina plaćanja:
        </p>
        <p class="paragraph-222 legal-paragraph" style="width: 100%">
        ...
        <p class="paragraph-222 legal-paragraph" style="width: 100%">
            ...
            Ovaj način plaćanja podrazumeva direktnu uplatu na naš račun uplatnicom u bilo kojoj banci ili pošti, ili
            ...
            evidentiranju uplate, koju je neophodno izvršiti najkasnije 2 dana od trenutka kreiranja narudžbine. NAPOMENA: Dostava se plaća gotovinski kuriru prilikom isporuke.
            <strong>Ukoliko plaćate kao pravno lice, kontaktirajte nas za instrukcije i predračun.</strong>
        </p>
        ...
        <ul>
            <li>PR Hemingway sarađuje sa kurirskim službama Daily Express i AKS koje vrše isporuku na navedenu adresu kupca.</li>
            ...
            <li>Za sve narudžbine vrednosti 3.990,00 dinara i veće, kao i za robu sa naznakom ‘’besplatna dostava’’
