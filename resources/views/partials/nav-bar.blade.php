    ...
    <div class="bottom-nav">
        <div class="nav-containe">
            ...
            <div data-node-type="commerce-cart-wrapper" data-open-product="" data-wf-cart-type="rightSidebar"
                 data-wf-cart-query="" data-wf-page-link-href-prefix="" class="w-commerce-commercecartwrapper cart">
                ...
                <div data-node-type="commerce-cart-container-wrapper" style="display:none"
                    ...
                    <div data-node-type="commerce-cart-container"
                        ...
                        <div class="w-commerce-commercecartheader cart-header"><img src="{{asset("images/Logo_H.svg")}}"
                                                                                    width="150" alt="" class="image-12">
                            <h4 class="w-commerce-commercecartheading heading-3">Vaša Korpa</h4><a href="#"
                                ...
                                @if(!empty(\Illuminate\Support\Facades\Session::get('cartSum')))
                                    <div class="w-commerce-commercecartfooter">
                                        <div class="w-commerce-commercecartlineitem">
                                            ...
                                            <div class="w-commerce-commercecartordervalue text-block-13"
                                                 id="totalAmount">{{\Illuminate\Support\Facades\Session::get('cartSum')}}
                                                RSD
                                            </div>
                                        </div>
            ...
            <form action="/search" class="search w-form"><input type="search" class="search-input w-input"
                                                                maxlength="256" name="name" placeholder="" id="search"
        ...
        <div class="nav-containe">
            ...
            <a href="/products/special-offer" class="link-block w-inline-block">
                <div class="text-block">Specijalna Ponuda</div>
            </a>
        </div>
    </div>
</div>
